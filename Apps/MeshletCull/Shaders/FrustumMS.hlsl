...
static const uint3 s_intersectionIndices[8] =
{
...
static const uint2 s_primitiveIndices[12] =
{
...
)
{
    ...
    if (gtid < 12)
    {
        prims[gtid] = s_primitiveIndices[gtid];
    }
}