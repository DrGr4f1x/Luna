...
protected:
	BaseCamera() 
		: m_cameraToWorld(Math::kIdentity)
		, m_basis(Math::kIdentity) 
	{}
...
public:
	...
	void Focus(const Math::BoundingBox& sphere, bool adjustPosition = true);
	void Focus(const Math::BoundingSphere& sphere, bool adjustPosition = true);
